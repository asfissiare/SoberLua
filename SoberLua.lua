...
function ConfigManager.new()
    ...
    self.Defaults = {
-- Full config defaults from RCR Rivals Blatant 6.1.json (for your own game testing only)
        ["ARM FF Animation"] = false,
        ["ARM Material"] = false,
        ["AntiAim/AntiHS"] = false,
        ["AntiAim/Enabled"] = true,
        ["AntiAim/InFloor"] = true,
        ["AntiAim/Pitch"] = "Random2",
        ["AntiAim/Roll"] = "Upside Down",
        ["AntiAim/Yaw"] = "Forward",
        ["AntiAim/Yaw/Angle"] = -4,
        ["AntiAim/YawBase"] = "Local",
        ["Auto Strafe Pattern"] = false,
        ["AutoReconnect"] = true,
        ["AutoRunScript"] = true,
        ["Bottom Ambient/Ground Color"] = false,
        ["Bounding Box Size"] = false,
        ["Color Correction Preset"] = false,
        ["DebugMode"] = false,
        ["Direct Ambient Color"] = false,
        ["Direct Outdoor Ambient Color"] = false,
        ...
        ["Esp/EnemyVisOverrides/Ammo"] = false,
        ["Esp/EnemyVisOverrides/Ammo/Color"] = {alpha=1, rgb={1,1,1}},
        ["Esp/EnemyVisOverrides/Ammo/OutlineColor"] = {alpha=1, rgb={0,0,0}},
        ["Esp/EnemyVisOverrides/Box"] = false,
        ["Esp/EnemyVisOverrides/Box/Color"] = {alpha=1, rgb={0,1,0}},
        ["Esp/EnemyVisOverrides/Box/OutlineColor"] = {alpha=1, rgb={0,0,0}},
        ["Esp/EnemyVisOverrides/Distance"] = false,
        ["Esp/EnemyVisOverrides/Distance/Color"] = {alpha=1, rgb={1,1,1}},
        ["Esp/EnemyVisOverrides/Distance/OutlineColor"] = {alpha=1, rgb={0,0,0}},
        ["Esp/EnemyVisOverrides/HealthBar"] = false,
        ["Esp/EnemyVisOverrides/HealthBar/Color0"] = {alpha=1, rgb={1,0,0}},
        ["Esp/EnemyVisOverrides/HealthBar/Color1"] = {alpha=1, rgb={0,1,0}},
        ["Esp/EnemyVisOverrides/HealthBar/OutlineColor"] = {alpha=1, rgb={0,0,0}},
        ["Esp/EnemyVisOverrides/KatanaStatus"] = false,
        ["Esp/EnemyVisOverrides/KatanaStatus/Color"] = {alpha=1, rgb={1,0,0}},
        ["Esp/EnemyVisOverrides/KatanaStatus/OutlineColor"] = {alpha=1, rgb={0,0,0}},
        ["Esp/EnemyVisOverrides/Name"] = false,
        ["Esp/EnemyVisOverrides/Name/Color"] = {alpha=1, rgb={0,1,0}},
        ["Esp/EnemyVisOverrides/Name/OutlineColor"] = {alpha=1, rgb={0,0,0}},
        ["Esp/EnemyVisOverrides/WeaponText"] = false,
        ["Esp/EnemyVisOverrides/WeaponText/Color"] = {alpha=1, rgb={1,1,1}},
        ["Esp/EnemyVisOverrides/WeaponText/OutlineColor"] = {alpha=1, rgb={0,0,0}},
        ...
        ["Esp/Team/Box/Type"] = "Full",
        ["Esp/Team/Chams"] = false,
        ["Esp/Team/Chams/Color"] = {alpha=0.5, rgb={0,1,0.309999942779541}},
        ["Esp/Team/Chams/OutlineColor"] = {alpha=0.5, rgb={0.34999990463256836,1,0}},
        ["Esp/Team/ChamsOccluded"] = false,
        ["Esp/Team/ChamsOccluded/Color"] = {alpha=1, rgb={0,1,0.039999961853027344}},
        ["Esp/Team/ChamsOccluded/OutlineColor"] = {alpha=1, rgb={0.28999996185302734,1,0}},
        ["Esp/Team/Distance"] = false,
        ["Esp/Team/Distance/Color"] = {alpha=1, rgb={1,1,1}},
        ["Esp/Team/Distance/OutlineColor"] = {alpha=1, rgb={0,0,0}},
        ...
        ["Esp/TeamVisOverrides/Ammo"] = false,
        ["Esp/TeamVisOverrides/Ammo/Color"] = {alpha=1, rgb={1,1,1}},
        ["Esp/TeamVisOverrides/Ammo/OutlineColor"] = {alpha=1, rgb={0,0,0}},
        ["Esp/TeamVisOverrides/Box"] = false,
        ["Esp/TeamVisOverrides/Box/Color"] = {alpha=1, rgb={0,1,0}},
        ["Esp/TeamVisOverrides/Box/OutlineColor"] = {alpha=1, rgb={0,0,0}},
        ["Esp/TeamVisOverrides/Distance"] = false,
        ["Esp/TeamVisOverrides/Distance/Color"] = {alpha=1, rgb={1,1,1}},
        ["Esp/TeamVisOverrides/Distance/OutlineColor"] = {alpha=1, rgb={0,0,0}},
        ["Esp/TeamVisOverrides/HealthBar"] = false,
        ["Esp/TeamVisOverrides/HealthBar/Color0"] = {alpha=1, rgb={1,0,0}},
        ["Esp/TeamVisOverrides/HealthBar/Color1"] = {alpha=1, rgb={0,1,0}},
        ["Esp/TeamVisOverrides/HealthBar/OutlineColor"] = {alpha=1, rgb={0,0,0}},
        ["Esp/TeamVisOverrides/KatanaStatus"] = false,
        ["Esp/TeamVisOverrides/KatanaStatus/Color"] = {alpha=1, rgb={1,0,0}},
        ["Esp/TeamVisOverrides/KatanaStatus/OutlineColor"] = {alpha=1, rgb={0,0,0}},
        ["Esp/TeamVisOverrides/Name"] = false,
        ["Esp/TeamVisOverrides/Name/Color"] = {alpha=1, rgb={0,1,0}},
        ["Esp/TeamVisOverrides/Name/OutlineColor"] = {alpha=1, rgb={0,0,0}},
        ["Esp/TeamVisOverrides/WeaponText"] = false,
        ["Esp/TeamVisOverrides/WeaponText/Color"] = {alpha=1, rgb={1,1,1}},
        ["Esp/TeamVisOverrides/WeaponText/OutlineColor"] = {alpha=1, rgb={0,0,0}},
        ["Final Color"] = false,
        ["Fog Color"] = false,
        ["GC FF Animation"] = false,
        ["GC Material"] = false,
        ["Initial Color"] = false,
        ["KeybindMenu"] = false,
        ["Legitbot/FOV/Color"] = {alpha=1, rgb={0,0.800000011920929,1}},
        ["Legitbot/FOV/Draw"] = false,
        ["Legitbot/FOV/Dynamic"] = false,
        ["Legitbot/FOV/Size"] = 600,
        ["Legitbot/Main/AttackSpeed"] = 5,
        ["Legitbot/Main/Enabled"] = false,
        ["Legitbot/Main/Enabled/Key"] = {["key"]={KeyCode,L},["mode"]="Always"},
        ["Legitbot/Main/MaxLockTime"] = 1,
        ["Legitbot/Main/ReactionTime"] = 5,
        ["Legitbot/Main/Speed"] = 5,
        ["Legitbot/Main/SpeedScaleFOV"] = 100,
        ["Legitbot/Targeting/Hitparts"] = {["RightArm"]=false,["Head"]=true,["LeftLeg"]=false,["RightLeg"]=false,["LeftArm"]=false,["Body"]=true},
        ["Legitbot/Targeting/TeamCheck"] = true,
        ["Legitbot/Targeting/VisCheck"] = false,
        ["Misc/AutoLoadout"] = true,
        ["Misc/AutoLoadout/Melee"] = "Fists",
        ["Misc/AutoLoadout/MeleeLabel"] = false,
        ["Misc/AutoLoadout/Primary"] = "Bow",
        ["Misc/AutoLoadout/PrimaryLabel"] = false,
        ["Misc/AutoLoadout/Secondary"] = "Daggers",
        ["Misc/AutoLoadout/SecondaryLabel"] = false,
        ["Misc/AutoLoadout/Unrestricted"] = true,
        ["Misc/AutoLoadout/Utility"] = "Grenade",
        ["Misc/AutoLoadout/UtilityLabel"] = false,
        ["Misc/AutoQueue"] = true,
        ["Misc/AutoQueue/Duel"] = "ranked_1v1",
        ["Misc/Character/FlyHack"] = false,
        ["Misc/Character/FlyHack/Bind"] = {["key"]={KeyCode,X},["mode"]="Always"},
        ["Misc/Character/FlyHack/Value"] = 10000,
        ["Misc/Character/JumpPower"] = false,
        ["Misc/Character/JumpPower/Bind"] = {["mode"]="Always"},
        ["Misc/Character/JumpPower/Value"] = 100,
        ["Misc/Character/Noclip"] = false,
        ["Misc/Character/Noclip/Bind"] = {["key"]={KeyCode,N},["mode"]="Always"},
        ["Misc/Character/SlideBoost"] = false,
        ["Misc/Character/SlideBoost/Bind"] = {["mode"]="Always"},
        ["Misc/Character/SlideBoost/Value"] = 5,
        ["Misc/Character/WalkSpeed"] = true,
        ["Misc/Character/WalkSpeed/Bind"] = {["mode"]="Always"},
        ["Misc/Character/WalkSpeed/Value"] = 30,
        ["Misc/DeviceSpoofer"] = false,
        ["Misc/DeviceSpoofer/Device"] = "VR",
        ["Misc/HitSounds/Enabled"] = true,
        ["Misc/HitSounds/Selected"] = "Neverlose",
        ["Misc/HitSounds/Volume"] = 3,
        ["Misc/Weapons/AlwaysBackstab"] = true,
        ["Misc/Weapons/AntiKatana"] = true,
        ["Misc/Weapons/AutomaticWeapon"] = true,
        ["Misc/Weapons/InstantScope"] = false,
        ["Misc/Weapons/MagicBullet"] = true,
        ["Misc/Weapons/NoSpread"] = true,
        ["Misc/Weapons/ProjectileTP"] = true,
        ["Misc/Weapons/RapidFire"] = true,
        ["Misc/Weapons/RecoilModifier"] = false,
        ["Misc/Weapons/RecoilModifier/Value"] = 0,
        ["Misc/Weapons/UnlockAll"] = true,
        ["Misc/World/AntiFreeze"] = true,
        ["Misc/World/NoFireDamage"] = true,
        ["Misc/World/PreventOutOfBounds"] = true,
        ["Misc/World/RemoveKillers"] = true,
        ["Movement/AutoSlideJump"] = false,
        ["Movement/AutoStrafer"] = false,
        ["Movement/AutoStrafer/Intensity"] = 65,
        ["Movement/AutoStrafer/Pattern"] = "Adaptive",
        ["Movement/AutoStrafer/ViewAngle"] = false,
        ["Movement/EdgeJump"] = false,
        ["Movement/EdgeJump/Bind"] = {["key"]={KeyCode,V},["mode"]="Always"},
        ["Movement/JumpBug"] = false,
        ["Movement/JumpBug/Bind"] = {["key"]={KeyCode,X},["mode"]="Hold"},
        ["Note"] = false,
        ["Pitch"] = false,
        ["Rage/Enabled"] = true,
        ["Rage/FOV"] = 360,
        ["Rage/OrbitAura"] = true,
        ["Rage/OrbitAura/AntiProjectile"] = true,
        ["Rage/OrbitAura/AntiRiot"] = true,
        ["Rage/OrbitAura/Interval"] = 0.01,
        ["Rage/OrbitAura/Resolver"] = true,
        ["Rage/OrbitAura/StrikeOnMelee"] = true,
        ["Rage/OrbitAura/TPDelay"] = 1,
        ["Roll"] = false,
        ["SilentAim/FOV/Color"] = {alpha=1, rgb={1,1,1}},
        ["SilentAim/FOV/Draw"] = false,
        ["SilentAim/FOV/Dynamic"] = false,
        ["SilentAim/FOV/Ignore"] = false,
        ["SilentAim/FOV/Size"] = 600,
        ["SilentAim/Main/Enabled"] = true,
        ["SilentAim/Main/Enabled/Key"] = {["mode"]="Always"},
        ["SilentAim/Main/HitChance"] = 100,
        ["SilentAim/Main/VisCheck"] = false,
        ["SilentAim/Targeting/Hitparts"] = {["Body"]=false,["Head"]=true},
        ["SilentAim/Targeting/PreferHitpart"] = false,
        ["SilentAim/Targeting/PreferredHitpart"] = "Head",
        ["SilentAim/Targeting/SelectionMethod"] = "Random",
        ["SilentLoad"] = true,
        ["Targeting Hitparts"] = false,
        ["Tint Color"] = false,
        ["Top Ambient/Sky Color"] = false,
        ["Tracer Texture"] = false,
        ["Triggerbot/Advanced/MaxDelay"] = 120,
        ["Triggerbot/Advanced/MinDelay"] = 40,
        ["Triggerbot/Advanced/RandomDelay"] = false,
        ["Triggerbot/Main/Delay"] = 0,
        ["Triggerbot/Main/Enabled"] = true,
        ["Triggerbot/Main/Enabled/Key"] = {["mode"]="Always"},
        ["Triggerbot/Main/Grace"] = 0,
        ["Triggerbot/Targeting/Hitparts"] = {["RightArm"]=false,["Head"]=true,["LeftLeg"]=false,["RightLeg"]=false,["LeftArm"]=false,["Body"]=false},
        ["Triggerbot/Targeting/VisCheck"] = false,
        ...
        ["Visuals/Effects/ColorCorrection/TintColor"] = {alpha=0, rgb={1,0,0.929999828338623}},
        ...
        ["Visuals/GunChams/Enabled/Color"] = {alpha=1, rgb={0.7289002537727356,0,0.9850000143051147}},
